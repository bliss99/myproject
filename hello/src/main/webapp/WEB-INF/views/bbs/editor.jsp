...
<div class="body">
	...
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="/saveProveTemp.bn" method="post" accept-charset="utf-8" target="ifm_callback">
		<!-- 에디터 컨테이너 시작 -->
...
<textarea id="sample_contents_source" style="display:none;">
	...
	<p>
		<a href="http://cfile297.uf.daum.net/attach/207C8C1B4AA4F5DC01A644"><img src="/daumeditor/snapshot/images/icon/p_gif_s.gif"/> editor_bi.gif</a>
	</p>
</textarea>
<script type="text/javascript">
